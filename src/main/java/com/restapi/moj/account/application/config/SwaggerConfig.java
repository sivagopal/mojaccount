...
public class SwaggerConfig {
    ...
    private static final String SWAGGER_API_LICENSE="License to create account CRUD operations";
    private static final String title="Accounts REST API";
    private static final String description="Restful API for accounts CRUD operations";
